...
Together, the evidence suggests that social information shapes the basic information gathering processes that support word learning. My dissertation work directly tests this information-seeking proposal. To do this, I decompose the concrete word learning task into three parts (see @frank2016performance) and ask how information from a social partner affects each sub-component:

  1. language comprehension
  2. social cue following
  3. linking a word to a concept

In our previous work, we characterized how children and adults choose to allocate visual attention between a social partner and objects during American Sign Language (ASL) comprehension ([Chapter 1](#ch1)). We then compared the dynamics of eye movements during ASL processing to those of spoken language learners, shwoing that ASL-learners gather more information about the linguistic signal before shifting away from a language source compared to spoken language learners. We proposed an information-seeking account to explain these modality differences and tested predictions of our account across a variety of language comprehension contexts. We found the same pattern of behavior for English-speaking adults processing displays of printed text and for children and adults processing degraded speech ([Chapter 2](ch2)). These results suggest that listeners flexibly adapt to the value of seeking higher value visual information with respect to the goal of rapid langauge comprehension.
...
Here, I propose a study that will connect our prior work on information seeking eye movements during familiar language comprehension with our work on the effects of social cues on cross-situational word learning. This goal of this study is to test predictions of our information seeking account in the novel word learning context. Testing these preditions will increase our understanding of how listeners flexibly adapt the dynamics of their eye movements to seek higher value information to support word learning. Overall, these results will synthesize ideas from research on active learning, social-pragmatic theories of language acqusition, and work on goal-based vision to increase our knowledge of how language processing and acquisition unfolds across a wider variety of populations and learning contexts.
